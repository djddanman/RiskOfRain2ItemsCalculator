...
def select_item_gui(items_dict):
    ...
    layout = [[sg.Combo(select_item_list, size=[20, 1], default_value=select_item_list[0]),
               sg.OK()]]
    ...
    layout = [[sg.Combo(select_effect_list, size=[20, 1], default_value=select_effect_list[0]),
               sg.OK()]]
...
if __name__ == '__main__':
    ...
    upper_bound = item_effect['limit'][1] + 2 if 'limit' in item_effect else 51
    ...
    for i in n:
        values.append(
            calculate_stack(item_effect['base_value'], item_effect['first_item'], item_effect['stack_effect'],
                            item_effect['stack_type'], i, item_effect['limit'][0] if 'limit' in item_effect else None))
